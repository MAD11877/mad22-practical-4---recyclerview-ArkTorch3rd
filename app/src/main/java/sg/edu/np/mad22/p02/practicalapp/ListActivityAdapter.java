...
public class ListActivityAdapter extends RecyclerView.Adapter<ListActivityViewHolder> {
    ...
    public ListActivityViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View item = null;
        item = (viewType == 0) ?
                (LayoutInflater.from(parent.getContext()).inflate(R.layout.user_view_2, null, false)) :
                (LayoutInflater.from(parent.getContext()).inflate(R.layout.user_view_1, null, false));
